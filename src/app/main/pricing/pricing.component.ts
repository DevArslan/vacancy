  ...
  cardData: { title: string, cost: number, description: string, imageLink: string , todos: string[]}[] = [
    {
      ...
      todos: ['Составление резюме', 'Поиск подходящих вакансий', 'Консультация со специалистом единоразово']
    },
    {
      title : 'Базовый',
      cost : 1000,
      ...
      todos: ['Составление резюме', 'Поиск подходящих вакансий', 'Консультация ограниченное количество раз']
    },
    {
      title : 'Продвинутый',
      cost : 1500,
      ...
      todos: ['Составление резюме', 'Поиск подходящих вакансий', 'Консультация перед каждым собеседованием', 'Проведение учебного собеседования онлайн', 'База возможных вопросов']
    }
  ]
